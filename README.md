...
- A basic, [Apollo Federation] subgraph with simple examples for queries, entities, and mutations. The datasource for this example is a MondoDB. You can run this subgraph with `npm start`.
...
- Create a `.env` file and add the `MONGODB_CONN` environment variable
  - This example assumes you have a "things" database with a "thing" collection
